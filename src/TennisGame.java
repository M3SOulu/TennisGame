...
public class TennisGame {
	...
	public String scorePlayerOne() {
		...
		if (playerOne.getPoint() == 0) {
			...
			} else if (playerTwo.getPoint() == 40 && playerTwo.isAdvantage() == false
	...
	public String scorePlayerTwo() {
		...
		if (playerTwo.getPoint() == 0) {
			...
			if (playerOne.getPoint() == 0) {
				...
				result = playerTwo.getName() + " scores > Score: " + playerOne.getPoint() + " - "
						+ playerTwo.getPoint();
			}
			...
			} else if (playerOne.getPoint() == 40 && playerOne.isAdvantage() == false
